...
contract CertificateUpload {
    ...
    function setCertificate(uint _roll, string memory _certificateHash) public {
        certificateHash[_roll] = _certificateHash;
    }
    
}


contract StudentManagementSystem is PayingFees, CertificateUpload {
